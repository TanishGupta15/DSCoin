...
public class MerkleTree {
  ...
  public List<Pair<String,String>> getPath(int idx){
    int num = numdocs;
    ...
    while(traversal.parent != null){
      ...
      Pair<String,String> p = new Pair<String,String>(traversal.left.val, traversal.right.val);
      path.add(p);
    }
    Pair<String,String> p = new Pair<String,String>(traversal.val, null);
    path.add(p);
    return path;
  }
}
